# Generated by Django 2.2.27 on 2022-04-21 15:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='event.Event_Users')),
                ('social_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='event.Event_Socials')),
            ],
        ),
        migrations.CreateModel(
            name='Event_Attendee',
